...
![資料行標示為「解決方案中的項目」和「功能中的項目」的功能設計工具。「執行方向增益集」是第一個而非第二個。](images/49ea0bf0-2cfa-4070-aa65-24b4a9c5e874.PNG)
...
4. When the calendar opens, click the event **Orient Cassie Hicks**. If the **Events** tab on the ribbon doesn't open automatically, open it. It should look similar to the following:
   ...
   **Events ribbon tab with custom button**
     ...
     ![包含名稱為「員工訓練」之自訂按鈕的事件功能區](images/916ecbba-11ff-45b6-a8e9-ba717ae6fe0b.png)
...
In the next article in this series, you'll add JavaScript to the SharePoint Add-in and access SharePoint data with SharePoint's JavaScript object model:  [使用 SharePoint JavaScript Api 來處理 SharePoint 資料](use-the-sharepoint-javascript-apis-to-work-with-sharepoint-data.md).
