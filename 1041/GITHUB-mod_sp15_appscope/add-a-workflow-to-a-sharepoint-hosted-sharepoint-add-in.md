...
> **メモ**
> ワークフローの設計のさまざまなタイミングで、内側に感嘆符がある青いダイヤ型の記号 ![小さくて青いひし形で、中に白い感嘆符があります。](images/f7b82a70-80fe-4e7e-a0f5-5a78cd12b367.PNG) がワークフロー デザイナーの 1 つ以上の項目に表示されます。これらは一時的なエラーを示します。(カーソルを記号の上に移動すると、短いメッセージが表示されます。詳細 Visual Studio の [ **エラー一覧**] を参照。) これらは不完全なワークフローの副作用です。この手順を終了すると、これらはすべて解決されるはずです。 
