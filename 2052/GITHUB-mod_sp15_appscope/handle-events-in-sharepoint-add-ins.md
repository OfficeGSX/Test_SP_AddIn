...
设计支持多个安全区域且具有远程事件接收器的外接程序时存在一些限制。有关详细信息，请参阅知识库文章 kb3135876  [在 SharePoint 2013 的非默认区域中使用提供程序托管的外接程序时无法从默认的 SharePoint 商店添加应用程序](https://support.microsoft.com/en-us/kb/3135876)。
