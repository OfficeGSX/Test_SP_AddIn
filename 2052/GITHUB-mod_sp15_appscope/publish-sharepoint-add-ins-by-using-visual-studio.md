...
-  [Microsoft Visual Studio 2013](http://go.microsoft.com/fwlink/?LinkId=517284  )
    ...
    -或者-
     ...
     [Visual Studio 2012](https://www.microsoft.com/en-us/download/details.aspx?id=30682) 和 Visual Studio Office 开发人员工具。若要下载这些工具，请参阅 [下载页](http://go.microsoft.com/fwlink/?LinkId=234393)的"工具"。（Visual Studio 2012 或更早版本中不提供新的发布管理器。）
